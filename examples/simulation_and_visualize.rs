...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("Average liquidity change: {:.4}", result.average_liquidity_change);
    ...
    create_simulation_analysis_chart(&analysis, "draws/simulation_analysis_chart.png", alpha, beta)?;
